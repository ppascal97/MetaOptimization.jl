...
#All_pbs = [arglina(10), arglinb(10), arglinc(10), arwhead(100), bdqrtic(100)]
...
#(test_pbs,valid_pbs) = benchmark_set(All_pbs,MPTRstruct;valid_ratio=0.1,load_dict="weightPerf.csv")

#metaoptimization(test_pbs,MPTRstruct,runNOMAD; logarithm=true,lhs=false,load_dict="weightPerf.csv",sgte_ratio=(1/sgte_cost),valid_pbs=valid_pbs,admitted_failure=0.05)
