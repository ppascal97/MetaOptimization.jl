...
function runMPTR2(model::T, parameters) where T<:AbstractNLPModel
    try
        t = @timed (solved,funcCalls,qual,gNorms,Clist)=mptr_nomad(model, quad_calls, parameters[1],parameters[2], 300000)
...
function runMPTR3(model::T, parameters) where T<:AbstractNLPModel
    try
        (solved,funcCalls,qual,gNorms,Clist)=mptr_nomad(model,quad_calls, parameters[1],parameters[2], 300000)
...
function runMPTR5(model::T, parameters) where T<:AbstractNLPModel
    try
        t = @timed (solved,funcCalls,qual,gNorms,Clist)=mptr_nomad(model,quad_calls, parameters[1],parameters[2], 50000)
        return 1000*t[2]/qual
    catch
        return Inf
    end
...
#function to run mptr on a given problem
function runMPTR6(model::T, parameters) where T<:AbstractNLPModel
    try
        (solved,funcCalls,qual,gNorms,Clist)=mptr_nomad(model, triple_calls, parameters[1],parameters[2], 300000)
        return funcCalls/qual
    catch
        return Inf
    end
...
weight_dict = "MPTRweightPerf1opt.csv"
...
tpb = tuningProblem(MPTRstruct,S_pbs;admitted_failure=0.08)
#=println(tpb.f([1.0, 0.026]))
println(tpb.f([0.67, 0.29]))
println(tpb.f([0.88, 4e-5]))
println(tpb.f([0.18, 1e-5]))
println(tpb.f([0.97, 0.00021]))=#
println(tpb.f([1.0, 0.25]))
println("")
tpb = tuningProblem(MPTRstruct,M_pbs,admitted_failure=0.08)
#=println(tpb.f([1.0, 0.026]))
println(tpb.f([0.67, 0.29]))
println(tpb.f([0.88, 4e-5]))
println(tpb.f([0.18, 1e-5]))
...
println(tpb.f([1.0, 0.25]))
println("")
tpb = tuningProblem(MPTRstruct,vcat(S_pbs,M_pbs),admitted_failure=0.08)
#=println(tpb.f([1.0, 0.026]))
println(tpb.f([0.67, 0.29]))
println(tpb.f([0.88, 4e-5]))
println(tpb.f([0.18, 1e-5]))
...
println(tpb.f([1.0, 0.25]))
println("")
tpb = tuningProblem(MPTRstruct,S_pbs;admitted_failure=0.08,weights=false)
#=println(tpb.f([1.0, 0.026]))
println(tpb.f([0.67, 0.29]))
println(tpb.f([0.88, 4e-5]))
println(tpb.f([0.18, 1e-5]))
...
println(tpb.f([1.0, 0.25]))
println("")
tpb = tuningProblem(MPTRstruct,M_pbs;admitted_failure=0.08,weights=false)
#=println(tpb.f([1.0, 0.026]))
println(tpb.f([0.67, 0.29]))
println(tpb.f([0.88, 4e-5]))
println(tpb.f([0.18, 1e-5]))
...
println(tpb.f([1.0, 0.25]))
println("")
tpb = tuningProblem(MPTRstruct,vcat(S_pbs,M_pbs);admitted_failure=0.08,weights=false)
#=println(tpb.f([1.0, 0.026]))
println(tpb.f([0.67, 0.29]))
println(tpb.f([0.88, 4e-5]))
println(tpb.f([0.18, 1e-5]))
